...
config.General.requestName = 'Bsmumuphi_2016D'
config.General.workArea = 'crab_projects_Bsmumuphi_2016D'
...
config.Data.outputDatasetTag = 'CRAB3_Bsmumuphi_2016D'
config.Data.outLFNDirBase = '/store/user/'+getUsernameFromSiteDB()+'/Bsmumuphi_2016D/'
