...
config.General.requestName = 'Bsmumuphi_2016B_2'
config.General.workArea = 'crab_projects_Bsmumuphi_2016B_2'
...
config.Data.outputDatasetTag = 'CRAB3_Bsmumuphi_2016B_2'
config.Data.outLFNDirBase = '/store/user/'+getUsernameFromSiteDB()+'/Bsmumuphi_2016B_2/'
